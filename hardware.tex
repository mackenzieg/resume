...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Innovated and developed the proprietary \href{https://patentimages.storage.googleapis.com/be/ad/28/d9a3cf28a032ae/WO2024039793A1.pdf}{Tesla Transport Protocol (TTP)} over Layer 3—a congestion-aware protocol enabling low-latency, high-throughput communication across DOJO fabric}
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    {\textbf{mmWave Radar Vital Sign Detection} $|$ \emph{Full-Time Research (2020 -- 2021)}}{}
      \resumeItemListStart
        \resumeItem{Developed a 60GHz mmWave radar system to detect breathing rates remotely, aiding nurses with highly infectious patients.}
        \resumeItem{Designed a signal processing algorithm in MATLAB using wavelet transforms and auto-correlation to accurately detect breathing rates at distances up to 10 meters.}
        \resumeItem{Implemented a real-time client-server architecture in Python and C++ to offload computation and streamline system responsiveness.}
      \resumeItemListEnd
