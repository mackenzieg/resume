...
\section{Experience}
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Designing next generation DOJO silicon targeting maximum compute density, enabling both scale-up within a rack and scale-out across racks for large-scale AI training workloads}
      \resumeItem{Designing a dedicated silicon chip to advance FSD and Optimus robot capabilities}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{PCB and FPGA design of a custom high-density compute cluster with integrated TTP-enabled NICs for DOJO's die-to-die fabric interconnect}
